        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="text-gray-300 hover:text-rose transition-colors">
          ...
          {/* Contact Information */}
          <div>
            <h3 className="text-xl font-playfair mb-4 text-rose">{t('nav.contact')}</h3>
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:ana@fortunahomesatl.com" className="text-gray-300 hover:text-rose transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+14049348516" className="text-gray-300 hover:text-rose transition-colors">
                  (404) 934-8516
                </a>
              </div>
              ...
              <button 
                ...
                className="mt-2 text-rose hover:text-white transition-colors flex items-center gap-2"
              >
                {t('footer.contactUs')}
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-playfair mb-4 text-rose">Links</h3>
            <ul className="flex flex-col gap-2">
              ...
              <li>
                <a href="#properties" className="text-gray-300 hover:text-rose transition-colors">
                  {t('nav.properties')}
                </a>
              </li>
              <li>
                <a href="#about" className="text-gray-300 hover:text-rose transition-colors">
                  {t('nav.about')}
                </a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:text-rose transition-colors">
                  {t('nav.contact')}
                </a>
              </li>
              <li>
