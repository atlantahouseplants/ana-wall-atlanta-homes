...
// Ana Wall Professional Photos
export const anaPhotos = {
  heroPhoto: "/lovable-uploads/98f77876-f6c8-4478-9ca1-87616290ea22.png", // Full body professional shot in navy suit
  aboutPhoto: "/lovable-uploads/a424100c-6f6f-4b29-876e-59201565a0d5.png", // Clean headshot with white jacket
  contactPhoto: "/lovable-uploads/631faac4-a98b-4710-b5f3-2596258723fa.png", // Friendly portrait in patterned blouse
  ctaPhoto: "/lovable-uploads/1ade2f13-f281-45e5-a3e2-503845556107.png" // Professional standing pose
};

// Agent Profile Image (legacy - keeping for backward compatibility)
